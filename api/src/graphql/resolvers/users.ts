  ...
  Query: {
    getUser: async (
      ...
      if (!authenticated || !userId) {
        logger.debug(
          'Could not get user details as user was not authenticated.'
        );
        throw new Error(
      ...
      if (!user) {
        ...
        throw new Error(
          'Could not find required user - username not in database.'
        );
      }
  ...
  Mutation: {
    createUser: async (
      ...
      if (foundUserByUsername) {
        ...
        throw new Error(
          'Username in use. Please provide alternative username.'
        );
      }
